...
/***/ function(module, exports, __webpack_require__) {
	...
	function onSubmit(e) {
	  ...
	  var tokens = (0, _index.tokenize)(e.target.formula.value);
	  var counts = (0, _index.countElements)(tokens);

	  resultEl.innerHTML = 'Counts: ' + JSON.stringify(counts) + '\n' + ('Mass: ' + (0, _index.getMass)(counts));
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.getMass = exports.countElements = exports.tokenize = undefined;

	var _tokenize = __webpack_require__(2);

	var _tokenize2 = _interopRequireDefault(_tokenize);

	var _countElements = __webpack_require__(3);

	var _countElements2 = _interopRequireDefault(_countElements);

	var _getMass = __webpack_require__(4);

	var _getMass2 = _interopRequireDefault(_getMass);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	exports.tokenize = _tokenize2.default;
	exports.countElements = _countElements2.default;
	exports.getMass = _getMass2.default;
...
/***/ function(module, exports) {
	...
	function tokenizeInitial(formula) {
	  ...
	  if (formula[0] === '(') {
	    return tokenizeInitial(formula.substr(1), [].concat(_toConsumableArray(tokens), [{
	      type: 'parenthesis',
	      value: 'open'
	    }]));
	  }
	  if (formula[0] === ')') {
	    return tokenizeAfterElement(formula.substr(1), [].concat(_toConsumableArray(tokens), [{
	      type: 'parenthesis',
	      value: 'close'
	    }]));
	  }
	  ...
	  if (num !== '') {
	    return tokenizeInitial(formula.substr(num.length), [].concat(_toConsumableArray(tokens), [{
	      type: 'coefficient',
	      value: Number(num)
	    }]));
	  }
	  ...
	  if (code >= 65 && code <= 90) {
	    ...
	    if (formula.length > 1) {
	      var nextChar = formula[1];
	      var nextCode = nextChar.charCodeAt(0);
	      if (nextCode >= 97 && nextCode <= 122) {
	        return tokenizeAfterElement(formula.substr(2), [].concat(_toConsumableArray(tokens), [{
	          type: 'element',
	          value: char + nextChar
	        }]));
	      }
	  ...
	  console.error('There was an error parsing your formula. We were able to get to here:\n' + JSON.stringify(tokens, null, 2), '\n\nRemaining formula: ' + formula);
...
/***/ function(module, exports) {
	...
	exports.default = countElements;
	function countElements(tokens) {
	  ...
	  for (var _i = 0; _i < tokens.length; _i++) {
	    if (tokens[_i].type === 'coefficient') {
	      return countInGroup(tokens.slice(1), elements, tokens[_i].value);
	    } else if (tokens[_i].type === 'element') {
	      return countInGroup(tokens, elements);
	    } else if (tokens[_i].type === 'operator') {
	      if (tokens[_i].value === 'hydrate') {
	        if (tokens.length > _i + 1 && tokens[_i + 1].type === 'coefficient') {
	          return countInGroup(tokens.slice(2), elements, tokens[_i + 1].value);
	        }
	        // if it's just plan .H2O
	        return countInGroup(tokens.slice(1), elements);
	      }
	    } else if (tokens[_i].type === 'parenthesis') {
	      if (tokens[_i].value === 'open') {
	        for (var j = _i; j < tokens.length; j++) {
	          if (tokens[j].type === 'parenthesis' && tokens[j].value === 'close') {
	            // There will always be a subscript after a parenthetical group
	            if (tokens.length > j + 1 && tokens[j].type === 'parenthesis' && tokens[j].value === 'close') {
	...
	function countInGroup(tokens, elements) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = getMass;

	var _ptable = __webpack_require__(5);

	var _ptable2 = _interopRequireDefault(_ptable);
	...
	function getMass(elements) {
	  ...
	  for (var i = 0; i < keys.length; i++) {
	    for (var j = 0; j < _ptable2.default.length; j++) {
	      if (_ptable2.default[j].symbol === keys[i]) {
	        var atomicMass = void 0;
	        var data = _ptable2.default[j].atomicMass;
	        if (typeof data === 'string') {
	          var parenthesis = data.indexOf('(');
